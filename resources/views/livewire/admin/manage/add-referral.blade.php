<div>
    ...
    @if ($isValid)
        ...
        <div>
            <span class="text-2xl font-semibold">Health Records</span>
            <div>
                <div class="mt-6 border-t border-gray-100">
                  <dl class="divide-y divide-gray-100">
        ...
        <div class="flex mt-4 justify-end space-x-4">
            <a href="{{ route('admin.referrals') }}" class="px-4 py-3 bg-gray-50 text-gray-500 font-semibold rounded-lg border border-gray-400">Cancel</a>
            <button wire:click="submitReferral" wire:confirm="Are you sure you want to submit this information?" class="px-4 py-3 bg-blue-500 text-white font-semibold rounded-lg">Submit</button>
        </div>
    @endif
</div>
