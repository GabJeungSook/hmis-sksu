<div>
    ...
    <div id="printarea" class="max-w-full bg-white p-4" class="font-mono">
        <div class="text-center mb-4">
            <h2 class="text-2xl font-bold">HIS Point Of Sale</h2>
        </div>
            ...
            <table class="w-full" style="border-style: dotted;">
                ...
                <tbody>
                    @foreach($transaction->transaction_items as $item)
                        <tr>
                            <td class="py-2 px-4 border text-center font-mono" style="border-style: dotted; border-color: black">{{$item->medicine->name}}</td>
